...
@section('container')
  ...
  @if ($posts->count())
    <div class="card mb-3">
      ...
      @else
        <img src="https://source.unsplash.com/random/800x400?computer={{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
      @endif
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-3">
        <div class="card">
          ...
          @else
            <img src="https://source.unsplash.com/random/500x400?computer={{ $post->category->name }}" class="card-img-top" alt="{{ $post->category->name }}">
          @endif
